  ...
  callWithJQuery(function($) {
    ...
    aggregators = (function(tpl) {
      return {
        ...
        "Conteo Valores Únicos": tpl.countUnique(usFmtInt),
        "Lista Valores Unicos": tpl.listUnique(", "),
        "Suma": tpl.sum(usFmt),
        ...
        "80% de Límite Sup": tpl.sumOverSumBound80(true, usFmt),
        "80% de límite Inf": tpl.sumOverSumBound80(false, usFmt),
        "Suma como Fracción del Total": tpl.fractionOf(tpl.sum(), "total", usFmtPct),
        "Suma como Fraccin de las filas": tpl.fractionOf(tpl.sum(), "row", usFmtPct),
        "Suma como Fraccin de las Columnas": tpl.fractionOf(tpl.sum(), "col", usFmtPct),
        "Contar como Fracción del Total": tpl.fractionOf(tpl.count(), "total", usFmtPct),
        "Contar como Fraccin de las filas": tpl.fractionOf(tpl.count(), "row", usFmtPct),
        "Contar como Fraccin de las Columnas": tpl.fractionOf(tpl.count(), "col", usFmtPct)
      };
    })(aggregatorTemplates);
    renderers = {
      ...
      "Tabla Barchart": function(data, opts) {
        return $(pivotTableRenderer(data, opts)).barchart();
      },
      "Mapa de Calor": function(data, opts) {
        return $(pivotTableRenderer(data, opts)).heatmap("heatmap", opts);
      },
      "Mapa de Calor por fila": function(data, opts) {
        return $(pivotTableRenderer(data, opts)).heatmap("rowheatmap", opts);
      },
      "Mapa de Calor por Col": function(data, opts) {
